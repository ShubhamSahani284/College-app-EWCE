    ...
    return Scaffold(
      ...
      body:  SingleChildScrollView(
        ...
        child : DataTable(
          columnSpacing: 18.0,
          columns: const [
            DataColumn(label: Text('Results of VTU')),
          ...
          rows: const [
            ...
            DataRow(cells: [
              DataCell(Text('1st sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('2nd sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('3rd sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('4th sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('5th sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('6th sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('7th sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
            DataRow(cells: [
              DataCell(Text('8th sem')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
              DataCell(Text('Mark')),
            ]),
